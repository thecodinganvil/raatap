-- =====================================================
-- DEPLOY MATCH MANAGEMENT FUNCTIONS
-- =====================================================
-- This file contains the accept_match_suggestion function
-- Run this in Supabase SQL Editor to enable host accept functionality
-- =====================================================

-- Drop existing function if exists (to allow parameter changes)
...
-- =====================================================
-- Confirms the match and activates pod membership
...
-- =====================================================
-- Skips/rejects a match suggestion
...
-- AND routine_name IN ('accept_match_suggestion', 'confirm_match_suggestion', 'skip_match_suggestion');
...
-- SELECT accept_match_suggestion('match-id-uuid', 'host-id-uuid', 'My Pod');

-- Rider confirms a match:
-- SELECT confirm_match_suggestion('match-id-uuid', 'rider-id-uuid');

-- Host skips a match:
-- SELECT skip_match_suggestion('match-id-uuid', 'host-id-uuid', 'host');

-- Rider skips a match:
-- SELECT skip_match_suggestion('match-id-uuid', 'rider-id-uuid', 'rider');
