      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              {/* Circle border */}
              <div className="absolute inset-0 rounded-full border-2 border-[#6675FF] opacity-0 group-hover:opacity-100 transition-opacity" style={{width: '56px', height: '56px', top: '-8px', left: '-8px'}}></div>
          ...
          {!user && (
            <div className="px-3 py-1 rounded-full bg-gray-100 border border-gray-200">
              <span className="text-xs font-semibold text-red-600">NOT VERIFIED !</span>
            </div>
          )}
        </div>
      </div>
