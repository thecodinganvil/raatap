            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
              ...
              <div className="flex-1 flex justify-center lg:justify-end">
                <div className="relative w-full max-w-md lg:max-w-lg">
                  <Image
                    src="/aboutus_one.png"
                    alt="Community of people connecting through Raatap ride sharing"
                    width={500}
                    height={400}
                    className="w-full h-auto object-contain"
                  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12 lg:gap-20">
              ...
              <div className="flex flex-col items-start">
                <div className="mb-6">
                  <Image
                    ...
                    alt="Community Support - Raatap feature"
                    width={80}
                    height={80}
              ...
              <div className="flex flex-col items-start">
                <div className="mb-6">
                  <Image
                    src="/trust.png"
                    alt="Trust - Verified members on Raatap"
                    width={80}
                    height={80}
                    className="w-20 h-20 object-contain"
                  />
              ...
              <div className="flex flex-col items-start">
                <div className="mb-6">
                  <Image
                    src="/cost_saving.png"
                    alt="Cost Savings - Save money with Raatap"
                    width={80}
                    height={80}
                    className="w-20 h-20 object-contain"
                  />
