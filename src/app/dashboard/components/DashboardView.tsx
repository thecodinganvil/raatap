                        ...
                        <div className="relative z-10">
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            ...
                            <span className="text-xs font-semibold text-gray-500">
                              {pod.ride_templates.seats_taken}/
                              {pod.ride_templates.available_seats} Seats
                            </span>
                          </div>
                        </div>
                      </div>
                              ...
                              >
                                <div className="flex items-center gap-3 mb-3">
                                  ...
                                  <a
                                    ...
                                    className="ml-auto w-8 h-8 flex items-center justify-center bg-gray-100 text-gray-600 rounded-full hover:bg-[#6675FF] hover:text-white transition-colors"
                                  >
                                    <svg
                                      className="w-4 h-4"
                                      fill="none"
                    ...
                    <div key={ride.id} className="space-y-4">
                      <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                        ...
                        <a
                          ...
                          className="ml-auto w-10 h-10 flex items-center justify-center bg-green-100 text-green-600 rounded-full hover:bg-green-200 transition-colors"
                        >
                          <svg
                            className="w-5 h-5"
                            fill="none"
