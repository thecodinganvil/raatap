...
<div className="bg-green-50 p-2 rounded-lg border border-green-100">
                                                   ...
                                                   <span className="text-gray-700 font-medium">
                                                     ₹{Math.round(((member.overlapping_distance_meters || 5000) / 1000) * 4)} ({Math.round((member.overlapping_distance_meters || 5000) / 1000)} km)
                                                   </span>
                                                 </div>
                                           </div>
                                          </div>
                         ...
                         {ride.pod?.pod_members?.length > 1 && (
                          ...
                          <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                            ...
                            <div className="flex items-center gap-1.5 text-gray-600">
                                ...
                                <span>₹{Math.round(((ride.overlapping_distance_meters || 5000) / 1000) * 4)} ({Math.round((ride.overlapping_distance_meters || 5000) / 1000)} km)</span>
                              </div>
                          </div>
